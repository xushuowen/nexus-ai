...
class WeatherSkill(BaseSkill):
    ...
    intent_patterns = [
        r"(今天|明天|這週|這幾天|後天).{0,10}(冷|熱|涼|穿什麼|帶傘|天氣|氣溫)",
        r"要(帶傘|穿外套|穿厚|穿薄|加件衣服)",
        r"(冷嗎|熱嗎|會下雨嗎|需要帶傘嗎|下雪嗎|有雨嗎)",
        r"(出門|外出).{0,10}(要帶|需要|穿|冷不冷|熱不熱)",
        r"(台北|台中|高雄|台南|新竹|花蓮|台東|基隆).{0,10}(今天|天氣|幾度|下雨)",
        r"(現在|外面).{0,10}(幾度|多冷|多熱|天氣|怎樣)",
